...
*/}}
{{- define "cnj-persistence-sql-backend-spring.name" -}}
...
*/}}
{{- define "cnj-persistence-sql-backend-spring.fullname" -}}
...
*/}}
{{- define "cnj-persistence-sql-backend-spring.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "cnj-persistence-sql-backend-spring.fullname" .) .Values.serviceAccount.name }}
{{- else }}
